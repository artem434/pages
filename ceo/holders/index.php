  ...
  <body>
      ...
      <section class="packages" id="packages">
        <div class="packages__container">
          <h2 class="packages__title">
            <span>УЧАСТЬ ДЛЯ РЕЗИДЕНТІВ КЛУБУ HŌLDERS</span> <br />ЗІ ЗНИЖКОЮ
            50%
          </h2>
    ...
    <script>
      $(document).ready(function () {
        window.location.href = "https://ceo.bizconstructor.com/new/";
        // Дата мероприятия
        let cDate = "5 вересня",
          // Landing id // Online
          cLandingId = "2108311000806846001",
