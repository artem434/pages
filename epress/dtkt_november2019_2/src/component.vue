<template>
    <landing name="dtkt_november2019_2" advantages="epressa_add_dtkt" class="landing-dtkt_november2019_2">
        ...
        <template v-slot:action-due>
            ...
            <p class="landing-section__action">Передплатити бухгалтерський сервіс «Дебет-Кредит» – це отримати у подарунок смартфон або планшет та ще й квиток до залу на Великий Кадровий Семінар!</p>
        ...
        <template v-slot:packages_list>
            <landing-package-row v-show="tab ==='6'">
                    <landing-package article="ep-dtkt_ek_2111" >
                        ...
                        <template v-slot:old-price>
                            <div class="package__old-price" style="text-decoration: line-through">1910 грн</div>
                        </template>
                    </landing-package>



                    <landing-package article="ep-dtkt_ek_2111p" class="package-plus">
                        ...
                        <template v-slot:abilities>
                            ...
                            <li class="package__abilities-item-platform">Бухгалтерська відеоплатформа  <a href="https://7eminar.ua" target="_blank">7eminar.ua</a>: понад 120 курсів та вебінарів для перегляду
                                <br> (січень – червень 2020 р.)</li>
                        </template>
                        <template v-slot:old-price>
                            <div class="package__old-price" style="text-decoration: line-through">2909 грн</div>
                        </template>
                    </landing-package>

                <landing-package article="ep-dtkt_pr_2111">
                    ...
                    <template v-slot:old-price>
                        <div class="package__old-price" style="text-decoration: line-through">2788 грн</div>
                    </template>
                </landing-package>

                <landing-package article="ep-dtkt_pp_2111" class="package-plus package-plus-top">
                    <template v-slot:title>ПРОФІ + 7eminar.ua<br>та подарунок</template>
                    <template v-slot:period><div class="period">січень – червень 2020</div> </template>
                    <template v-slot:gifts>
                        <li>квиток до залу на<br> <a href="https://7eminar.com/26112019" target="_blank">Великий Кадровий Семінар</a></li>
                        <li class="no-active">сучасний планшет або смартфон</li>
                    ...
                    <template v-slot:old-price>
                        <div class="package__old-price" style="text-decoration: line-through">3688 грн</div>
                    </template>
                </landing-package>

            </landing-package-row>
            <landing-package-row v-show="tab ==='12'" class="landing-package__twele">
                <landing-package article="ep-dtkt_ek_2111_gif" >
                    ...
                    <template v-slot:old-price>
                        <div class="package__old-price" style="text-decoration: line-through">7010 грн</div>
                    </template>
                </landing-package>



                <landing-package article="ep-dtkt_ek_2111p_gi" class="package-plus">
                    ...
                    <template v-slot:old-price>
                        <div class="package__old-price" style="text-decoration: line-through">8009 грн</div>
                    </template>
                </landing-package>

                <landing-package article="ep-dtkt_pr_2111_gif">
                    <template v-slot:title>ПРОФІ<br>та подарунки</template>
                    <template v-slot:period><div class="period">січень – червень 2020</div> </template>
                    <template v-slot:gifts>
                        <li>квиток до залу на<br> <a href="https://7eminar.com/26112019" target="_blank">Великий Кадровий Семінар</a></li>
                        <li >сучасний <a href="https://consumer.huawei.com/ua/tablets/mediapad-t3-7/" target="_blank">планшет</a> або <a href="https://consumer.huawei.com/ua/phones/y5-2018/" target="_blank">смартфон</a></li>
                    ...
                    <template v-slot:old-price>
                        <div class="package__old-price" style="text-decoration: line-through">7888 грн</div>
                    </template>
                </landing-package>

                <landing-package article="ep-dtkt_pp_2111_gif" class="package-plus package-plus-top">
                    ...
                    <template v-slot:old-price>
                        <div class="package__old-price" style="text-decoration: line-through">8788 грн</div>
                    </template>
                </landing-package>
