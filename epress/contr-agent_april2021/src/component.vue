<template>
    <landing name="contr-agent_december2020" advantages="epressa_add_interbuh" class="landing-contr-agent_april2021">
              ...
              <div class="cover">
                <a class="d-none d-md-block" href="#gift">
                  <picture class="cover__img">
                    <source :src="mix('images/05_ca.webp')" type="image/webp">
                    <img :src="mix('images/05_ca-min.jpg')" class="img-fluid" alt="IB">
                  </picture>
                </a>
                <a class="d-block d-md-none" href="#gift">
                  <picture class="cover__img">
                    <source :src="mix('images/05_ca_mob.webp')" type="image/webp">
                    <img :src="mix('images/05_ca_mob-min.jpg')" class="img-fluid" alt="IB">
                  </picture>
                </a>
              </div>
            </div>
