<template>
    <landing name="interbuh_december2020" advantages="epressa_add_interbuh" class="landing-interbuh_january2021_2">
                    ...
                    <div class="container">
                        <div class="cover">
                          ...
                          <a class="d-block d-md-none" href="#gift">
                            <picture class="cover__img">
                              <source :src="mix('images/02_ib_ mob-min.jpg')" type="image/webp">
                              <img :src="mix('images/02_ib_mob.webp')" class="img-fluid" alt="IB">
                            </picture>
                          </a>
                        </div>
                    </div>
                ...
                <landing-package article="ep-interbuh_st">
                  ...
                  <template v-slot:gifts>
                    <li ><a href="https://7eminar.com/21012021" target="_blank">Великий Річний <br>
                      Online-Семінар</a></li>
                    <li class="no-active">Пилосмок 2в1 Deerma</li>
                    </template>
