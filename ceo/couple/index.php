...
<html lang="uk-UA">
  <head>
    ...
    <title>
      CEO та Ефективний керівник | Інтенсивні освітні програми для керівників |
      Бізнес-Конструктор
    </title>
    <!-- SEO-->
    <meta
      property="og:title"
      content="CEO та Ефективний керівник | Інтенсивні освітні програми для керівників | Бізнес-Конструктор"
    />
    <meta
      property="og:description"
      content="Ідеальна пара освітніх програм для навчання перших осіб компанії"
    />
  ...
  <body>
          ...
          <div class="block">
            <div class="block__content">
              ...
              <p class="block__subtitle">
                НА ІДЕАЛЬНУ ПАРУ ПРОГРАМ «СЕО» + «Ефективний керівник»<br />
                <span>НА СПЕЦІАЛЬНИХ УМОВАХ та отримай бонус</span>
              </p>
      ...
      <section class="packages" id="packages">
        <div class="packages__container">
          <h2 class="packages__title">
            <span>ФОРМАТ УЧАСТІ В ПРОГРАМІ "СЕО"</span>
            <b>та в комплекті – програма "Ефективний керівник"</b>
          </h2>
          <div class="packages__items">
            <div class="item item--core core_price" data-id="">
              ...
              <ul class="item__info">
                ...
                <li>
                  Повноцінне навчання на програмі
                  <b>"Ефективний керівник" (пакет CORE)</b>
                </li>
              </ul>
              <a
                class="item__btn"
            ...
            <div class="item item--pro pro_price" data-id="">
              ...
              <ul class="item__info">
                ...
                <li>
                  Повноцінне навчання на програмі
                  <b>"Ефективний керівник" (пакет PRO) </b>
                </li>
              </ul>
              <a
                class="item__btn"
    ...
    <script>
      $(document).ready(function () {
        ...
        let cDate = "5 вересня",
          // Landing id // Online
          cLandingId = "2108311000829961001",
          // Landing id // Online Pro
          cLandingIdPro = "2108311000829961024",
          // es_mail_id
          cMail_id = "",
          // es_id
          cEs_id = "1154",
