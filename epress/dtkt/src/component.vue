<template>
    <landing name="dtkt" advantages="epressa_add_dtkt" class="landing-dtkt">
        <template v-slot:about_description>
            <p>«Дебет-Кредит» – бухгалтерський сервіс №1, який об'єднує бухгалтерів з усієї України.</p>
            <p>Щотижня він пропонує підбірку аналітичних статей, підготовлених висококваліфікованими фахівцями редакції, бухгалтерами-практиками, юристами, фахівцями держорганів.</p>
            <p>У ньому регулярно з’являється інформація про нові закони, нормативно-правові акти з докладними коментарями та практичними рекомендаціями. І разом з тим сервіс надає доступ до сотень готових відповідей у базі онлайн-консультацій.</p>
        </template>
        <template v-slot:price-title>
            <div>
                <h2 class="landing-title landing-title--columns"><span>ЦІНИ</span></h2>
            </div>
        </template>
        <template v-slot:packages_list>
            <landing-package-row>
                    ...
                    <landing-package article="ep-dtkt_ma">
