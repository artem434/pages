<template>
    <landing name="dtkt_november2020_2" advantages="epressa_add_interbuh" class="landing-dtkt_november2020_2">
          ...
          <landing-package-row class="package-two">
            <landing-package article="ep-dtkt_ek_action1">
              ...
              <template v-slot:old-price>
                <div  class="package__old-price" style="text-decoration: line-through">199 грн/міс.</div>
              </template>
            ...
            <landing-package article="ep-dtkt_pr_action1"class="package__two">
              ...
              <template v-slot:old-price>
                <div  class="package__old-price" style="text-decoration: line-through">349 грн/міс.</div>
              </template>
            ...
            <landing-package article="ep-dtkt_pp_action1" class="package__three package__plus-top">
              ...
              <template v-slot:old-price>
                <div  class="package__old-price" style="text-decoration: line-through">559 грн/міс.</div>
              </template>
              <template v-slot:gifts>
                <li ><a href="https://7eminar.com/msfz2020" target="_blank">Online-школа фінансів <br>
                  "МСФЗ. Легкий старт"</a></li>
