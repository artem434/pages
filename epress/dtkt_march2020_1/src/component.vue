<template>
    <landing name="dtkt_march2020_1" advantages="epressa_add_dtkt" class="landing-dtkt_march2020_1">
                    ...
                    <div class="container container--august">
                        <div class="cover">
                             <picture class="cover__img">
                                 <source :srcset="mix('images/head_031.webp')" type="image/webp">
                                 <img :src="mix('images/head_031.jpg')" class="img-fluid" alt="">
        ...
        <template v-slot:packages_list>
            <landing-package-row >
                <landing-package :article="tab =='6' ?  'ep-dtkt_ek' : 'ep-dtkt_ek_action'" class="packages__column--one">
                    ...
                    <template v-slot:old-price>
                        <div  v-if="tab =='6'" class="package__old-price" style="text-decoration: line-through">1915 грн</div>
                        <div  v-else class="package__old-price" style="text-decoration: line-through">3315 грн</div>
                    </template>
                </landing-package>

                <landing-package :article="tab =='6' ?  'ep-dtkt_ekp' : 'ep-dtkt_ekp_action'"  class="packages__column--two">
                    <template v-slot:title>
                    ...
                    <template v-slot:abilities>
                        ...
                        <li class="package__abilities-item-platform">Бухгалтерська відеоплатформа  <a href="https://7eminar.ua" target="_blank">7eminar.ua</a>: понад 120 курсів та вебінарів для перегляду
                            <br><span  > (березень - серпень 2020)</span> </li>
                    </template>
                    <template v-slot:old-price>
                        <div  v-if="tab =='6'" class="package__old-price" style="text-decoration: line-through">2914 грн</div>
                        <div  v-else class="package__old-price" style="text-decoration: line-through">4314 грн</div>
                    </template>
                </landing-package>

                <landing-package :article="tab =='6' ?  'ep-dtkt_pr' : 'ep-dtkt_pr_action'" class="packages__column--three">
                    <template v-slot:title>
                    ...
                    <template v-slot:old-price>
                        <div  v-if="tab =='6'" class="package__old-price" style="text-decoration: line-through">2593 грн</div>
                        <div  v-else class="package__old-price" style="text-decoration: line-through">3993 грн</div>
                    </template>
                </landing-package>

                <landing-package :article="tab =='6' ?  'ep-dtkt_pp' : 'ep-dtkt_pp_action'" class="package-plus package-plus-top">
                    <template v-slot:title>
                    ...
                    <template v-slot:old-price>
                        <div  v-if="tab =='6'" class="package__old-price" style="text-decoration: line-through">3592 грн</div>
                        <div  v-else class="package__old-price" style="text-decoration: line-through">4992 грн</div>
                    </template>
                </landing-package>
            </landing-package-row>
        </template>
