<template>
    <landing name="dtkt_august2020_3" advantages="epressa_add_dtkt" class="landing-dtkt__august2020_3">
                        ...
                        <div class="cover">
                            <a href="#gift">
                                <picture class="cover__img show-md">
                                       <source :srcset="mix('images/head_00.webp')" type="image/webp">
                                    <img :src="mix('images/head_00.jpg')" class="img-fluid" alt="">
                                </picture>
                              <picture class="cover__img hidden-md">
                                <source :srcset="mix('images/head_00_mobile.webp')" type="image/webp">
                                <img :src="mix('images/head_00_mobile.jpg')" class="img-fluid" alt="">
                              </picture>
                            </a>
                        </div>
                    </div>
        ...
        <template v-slot:price-title>
            <div>
                ...
                <div id="gift" class="landing-subtitle" v-html="page.options.subtitle"></div>
            ...
            <landing-package-row >
                <landing-package   article="ep-dtkt_ek_action1" class="packages__column--two">
                    <template v-slot:title>
                        <span>ЕКСПЕР<br>та подарунки</span>
