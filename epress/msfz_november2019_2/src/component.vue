<template>
    <landing name="msfz_november2019_2" advantages="epressa_add_msfz" class="landing-msfz_november2019_2">
                    ...
                    <div class="container container--august">
                        <div class="cover">
                            <picture class="cover__img">
                                <source :src="mix('images/head_033_webp.webp')" type="image/webp">
                                <img :src="mix('images/head_033.jpg')" class="img-fluid" alt="coffe">
                            </picture>
                        </div>
                    </div>
                </div>
        ...
        <template v-slot:action-due>
            <p class="landing-section__action">Передплатити журнал «Практика МСФЗ» – це отримати у подарунок смартфон або планшет та ще й квиток до залу на Великий Кадровий Семінар!</p>
        </template>
        ...
        <template v-slot:packages_list>
            <landing-package-row v-show="tab ==='6'">
                    <landing-package article="ep-msfz_2111">
                        <template v-slot:title>ПРАКТИКА МСФЗ <br> та подарунок</template>
                        ...
                        <template v-slot:old-price>
                            <div class="package__old-price" style="text-decoration: line-through">5204 грн</div>
                        </template>
                    </landing-package>
            </landing-package-row>
            <landing-package-row v-show="tab ==='12'">
                <landing-package article="ep-msfz_2111_gift">
                    <template v-slot:title>ПРАКТИКА МСФЗ <br> та подарунки</template>
                    <template v-slot:period><div class="period">січень – червень 2020</div> </template>
                    <template v-slot:gifts>
                        <li>квиток до залу на<br> <a href="https://7eminar.com/26112019" target="_blank">Великий Кадровий Семінар</a></li>
                    ...
                    <template v-slot:old-price>
                        <div class="package__old-price" style="text-decoration: line-through">10304 грн</div>
                    </template>
                </landing-package>
            </landing-package-row>
        </template>
