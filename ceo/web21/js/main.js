...
// Функція для оновлення дати щодня о 18:00 на наступний день
function updateDateDaily() {
  let now = new Date();
  if (now.getHours() >= 18) {
...
// Викликаємо цю функцію, щоб забезпечити оновлення дати щодня о 18:00
updateDateDaily();

// Виводимо оновлену дату
console.log(
