        ...
        <landing-package-row>
          <landing-package article="ep-dtkt_ek_gift2">
            ...
            <template v-slot:period>
              ...
              <p class="package__custom-price">
                <price article="ep-dtkt_ek_gift2" :options="{periods: 3}" format="0"/>
                <b>грн</b>
              </p>
            </template>
          ...
          <landing-package article="ep-dtkt_pr_gift2" class="package__two">
            ...
            <template v-slot:period>
              <div class="package__month">3 місяці</div>
              <p class="package__custom-price">
                <price article="ep-dtkt_pr_gift2" :options="{periods: 3}" format="0"/>   <b>грн</b>
              </p>
            </template>
          ...
          <landing-package article="ep-dtkt_pp_gift2" class="package__three package__plus-top">
            ...
            <template v-slot:period>
              <div class="package__month">3 місяці</div>
              <p class="package__custom-price">
                <price article="ep-dtkt_pp_gift2" :options="{periods: 3}" format="0"/>
                <b>грн</b>
              </p>
            </template>
            <template v-slot:gifts>
        ...
        <landing-package-row class="package-two">
          <landing-package article="ep-dtkt_ek_action2">
            ...
            <template v-slot:period>
              <div class="package__month">3 місяці</div>
              <p class="package__custom-price">
                <price article="ep-dtkt_ek_action2" :options="{periods: 3}" format="0"/>
                <b>грн</b>
              </p>
            </template>
          ...
          <landing-package article="ep-dtkt_pr_action2" class="package__two">
            ...
            <template v-slot:period>
              <div class="package__month">3 місяці</div>
              <p class="package__custom-price">
                <price article="ep-dtkt_pr_action2" :options="{periods: 3}" format="0"/>
                <b>грн</b>
              </p>
            </template>
          ...
          <landing-package article="ep-dtkt_pp_action2" class="package__three">
            ...
            <template v-slot:period>
              <div class="package__month">3 місяці</div>
              <p class="package__custom-price">
                <price article="ep-dtkt_pp_action2" :options="{periods: 3}" format="0"/>
                <b>грн</b>
              </p>
            </template>
            <template v-slot:gifts>
