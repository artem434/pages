...
function startCountdown() {
  var minutes = 3; // Изменим на 3 минуты
  var seconds = 0;
  var milliseconds = 0; // Начальное значение миллисекунд
  ...
  var countdown = setInterval(function () {
    if (minutes === 0 && seconds === 0 && milliseconds === 0) {
      // Если время закончилось, останавливаем таймер и устанавливаем "00:00:00"
    ...
    milliseconds -= 10; // Уменьшаем на 10 миллисекунд
    ...
    if (milliseconds < 0) {
      ...
      milliseconds = 990; // Возвращаем миллисекунды к 990 после секунды
    }
  ...
  }, 10); // Устанавливаем интервал на 10 миллисекунд (или любое другое значение по вашему выбору)
}
