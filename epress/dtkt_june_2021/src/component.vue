          ...
          <div class="container">
            <div class="hero__bg">
              <picture class="cover__img d-none d-md-block">
                <source :src="mix('images/hero_bg.webp')" type="image/webp">
                <img :src="mix('images/hero_bg-min.jpg')" class="img-fluid" alt="dk">
              </picture>

                  <picture class="cover__imgd-block d-md-none">
                    <source :src="mix('images/hero_bg_mob.webp')" type="image/webp">
                    <img :src="mix('images/hero_bg_mob-min.jpg')" class="img-fluid" alt="dk">
                  </picture>
            </div>
            ...
            <div class="hero__content">
              ...
              <p class="hero__title">Старт передплати</p>
              <p class="hero__subtitle">на 2022 рік розпочато!</p>
              <p class="hero__description">Отримайте смартфон або планшет <br>
                у подарунок при передплаті бухгалтерського <br>
                сервісу "Дебет-Кредит"</p>
              <p class="hero__btn">
                <a href="#gift" class="btn">Хочу передплатити</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <landing-package-row>
          <landing-package article="ep-dtkt_ek_action">
            ...
            <template v-slot:gifts>
              <li ><a href="https://7eminar.ua/06072021" target="_blank">Великий Бухгалтерський
                Семінар </a>(онлайн-трансляція та відеозапис)</li>
              <li><h5 class="package__presents-title">Оберіть подарунок:</h5></li>
              <li><a href="https://rozetka.com.ua/xiaomi_redmi_9a_2_32gb_granite_gray_m2006c3lg/p232347079/" target="_blank">Смартфон Xiaomi Redmi</a></li>
              <li><a href="https://allo.ua/ru/products/internet-planshety/lenovo-tab-m7-tb-7305x-16gb-4g-onyx-black-za570039ua.html" target="_blank">Планшет Lenovo</a></li>
            </template>
          ...
          <landing-package article="ep-dtkt_pr_action" class="package__two">
            ...
            <template v-slot:period>
              <div class="package__month">6 місяців</div>
              <p class="package__custom-price">
                <price article="ep-dtkt_pr_action" :options="{periods: 6}" format="0"/>   <b>грн</b>
              </p>
            </template>
            <template v-slot:gifts>
              <li ><a href="https://7eminar.ua/06072021" target="_blank">Великий Бухгалтерський
