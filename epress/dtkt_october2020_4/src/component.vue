<template>
    <landing name="dtkt_october2020_4" advantages="epressa_add_interbuh" class="landing-dtkt_october2020_4">
                    ...
                    <div class="container">
                        <div class="cover">
                          ...
                          <a class="d-block d-md-none" href="#gift">
                            <picture class="cover__img">
                              <source :src="mix('images/dk_mobile.webp')" type="image/webp">
                              <img :src="mix('images/dk_mobile-min.jpg')" class="img-fluid" alt="dk">
                            </picture>
                          </a>
                        </div>
                    </div>
          ...
          <h2  id="gift" class="packages__title">{{ page.options['order_title-top']}}</h2>
            <landing-package-row>
                <landing-package article="ep-dtkt_ek_action1">
                    ...
                    <template v-slot:period>
                      ...
                      <p class="package__custom-price">
                        <price article="ep-dtkt_ek_action1" :options="{periods: 3}" format="0"/>
                        грн
                      </p>
                    </template>
                ...
                <template v-slot:period>
                  <div class="package__month">3 місяці</div>
                  <p class="package__custom-price">
                    <price article="ep-dtkt_pr_action1" :options="{periods: 3}" format="0"/>
                    грн
                  </p>
                </template>
                        ...
                        <template v-slot:title>
                          <span>ПРОФІ + 7eminar.ua<br>та подарунки</span>
                            ...
                            <template v-slot:period>
                              <div class="package__month">3 місяці</div>
                              <p class="package__custom-price">
                                <price article="ep-dtkt_pp_action1" :options="{periods: 3}" format="0"/>
                                грн
                              </p>
                            </template>
                        <template v-slot:gifts>
