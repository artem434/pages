...
<html lang="uk-UA">
  <head>
    ...
    <title>
      СЕО аграрного бізнесу | Індивідуальна освітня програма для керівників |
      Бізнес-Конструктор
    </title>
    <!-- SEO-->
    <meta
      property="og:title"
      content="СЕО аграрного бізнесу | Індивідуальна освітня програма для керівників | Бізнес-Конструктор"
    />
    <meta
  ...
  <body>
        ...
        <div class="for__container">
          <div class="for__block">
            ...
            <div class="for__items">
              <div class="item">
                <h3 class="item__title">CEO аграрного бізнесу</h3>
                <p class="item__text">
                  які хочуть удосконалити стратегію управління, автоматизувати
                  процеси та збільшити прибутковість
                </p>
              </div>
              <div class="item">
                <h3 class="item__title">Власники фермерських господарств</h3>
                <p class="item__text">
                  що прагнуть підвищити ефективність роботи, оптимізувати
                  ланцюги постачання і залучити нові ринки збуту 
                </p>
              </div>
              <div class="item">
                <h3 class="item__title">Керівники агропідприємств</h3>
                <p class="item__text">
                  які планують розширення виробництва, модернізацію та
                  впровадження новітніх технологій у бізнес
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="block">
            <div class="block__content">
              ...
              <p class="block__subtitle">
                НА ПРОГРАМУ «СЕО АГРАРНОГО БІЗНЕСУ» <br />
              ...
              <form class="form zoho_url" id="form" method="post">
                ...
                <div class="hidden">
                  ...
                  <input
                    ...
                    autocomplete="off"
                  />
                  <input type="hidden" name="send_to_gf" value="gf_agroceo" />
                </div>
    ...
    <script>
      $(document).ready(function () {
        ...
        let cDate = "5 вересня",
          // Landing id // Online
          cLandingId = "2108311001025837161",
          // Landing id // Online Pro
          cLandingIdPro = "2108311001025837161",
          // Landing id // Online Pro
          cLandingIdPremium = "2108311001025837161",
          // es_mail_id
          cMail_id = "",
          // es_id
          cEs_id = "1154",
          // success_url
          cSuccess_url = "https://ceo.bizconstructor.com/agroceo/thanks.html";
