<template>
    <landing name="dtkt_december2020" advantages="epressa_add_interbuh" class="landing-dtkt_february2021_2">
                        ...
                        <div class="cover">
                          ...
                          <a class="d-block d-md-none" href="#gift">
                            <picture class="cover__img">
                              ...
                              <img :src="mix('images/dk__mob-min.jpg')" class="img-fluid" alt="dk">
                            </picture>
                          </a>
                        </div>
                    </div>
...
<!--                      <div class="package__month">3 місяці</div>-->
                ...
                <template v-slot:period>
                  ...
                  <p class="package__custom-price">
                    <price article="ep-dtkt_pr_gift1" :options="{periods: 1}" format="0"/>   <b>грн/міс.</b>
                  </p>
                </template>
