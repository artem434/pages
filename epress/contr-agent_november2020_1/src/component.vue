<template>
    <landing name="contr-agent_november2020_1" advantages="epressa_add_interbuh" class="landing-contr-agent_november2020_1">
                    ...
                    <div class="container">
                        <div class="cover">
                          ...
                          <a class="d-block d-md-none" href="#gift">
                            <picture class="cover__img">
                              <source :src="mix('images/contr-mob.webp')" type="image/webp">
                              <img :src="mix('images/contr-mob.png')" class="img-fluid" alt="IB">
                            </picture>
                          </a>
                        </div>
                    </div>
            ...
            <landing-package-row>
                <landing-package article="ep-contr-agent_ek_action">
                    ...
                    <template v-slot:gifts>
                      <li ><a href="https://7eminar.com/msfz2020" target="_blank">Online-школа фінансів <br>
                        "МСФЗ. Легкий старт"</a></li>
                      <li><a href="https://rozetka.com.ua/special4you_e0949/p11117978/characteristics/" target="_blank">Офісне крісло</a></li>
                    </template>
