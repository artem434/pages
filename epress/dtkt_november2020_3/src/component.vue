<template>
    <landing name="dtkt_november2020_3" advantages="epressa_add_interbuh" class="landing-dtkt_november2020_3">
                        ...
                        <div class="cover">
                            <a class="d-none d-md-block" href="#gift">
                                <picture class="cover__img">
                                    <source :src="mix('images/hero_dk.webp')" type="image/webp">
                                    <img :src="mix('images/hero_dk-min.jpg')" class="img-fluid" alt="dk">
                                </picture>
                            </a>
          ...
          <h2  id="gift" class="packages__title">{{ page.options['order_title-top']}}</h2>
            <landing-package-row>
                <landing-package article="ep-dtkt_ek_gift1">
                    ...
                    <template v-slot:period>
                      ...
                      <p class="package__custom-price">
                        <price article="ep-dtkt_ek_gift1" :options="{periods: 6}" format="0"/>
                        грн
                      </p>
                    </template>
                ...
                <template v-slot:period>
                  <div class="package__month">6 місяців</div>
                  <p class="package__custom-price">
                    <price article="ep-dtkt_pr_gift1" :options="{periods: 6}" format="0"/> грн
                  </p>
                </template>
                        ...
                        <template v-slot:title>
                          <span>ПРОФІ + 7eminar.ua<br>та подарунки</span>
                            ...
                            <template v-slot:period>
                              <div class="package__month">6 місяців</div>
                              <p class="package__custom-price">
                                <price article="ep-dtkt_pp_gift1" :options="{periods: 6}" format="0"/>
                                грн
                              </p>
                            </template>
                        <template v-slot:gifts>
