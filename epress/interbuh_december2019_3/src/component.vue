<template>
    <landing name="interbuh_december2019_3" advantages="epressa_add_interbuh" class="landing-interbuh_december2019_3">
                    ...
                    <div class="container container--august">
                        <div class="cover">
                            <picture class="cover__img">
                                <source :src="mix('images/head_02_webp.webp')" type="image/webp">
        ...
        <template v-slot:packages_list>
            <landing-package-row>
                <landing-package article="ep-interbuh_st_1012">
                    <template v-slot:title>
                        <span > ТАРИФ<br>«СТАНДАРТ»<br>та подарунки</span>
                    </template>
                    ...
                    <template v-slot:old-price>
                        <div  class="package__old-price" style="text-decoration: line-through">2306 грн</div>
                    </template>
                </landing-package>
                <landing-package article="ep-interbuh_pr_1012">
                    <template v-slot:title>

                        <span > ТАРИФ<br>«ПРЕМІУМ»<br>та подарунки</span>
                    </template>
                    <template v-slot:period><div class="period">січень - червень 2020</div> </template>
                    <template v-slot:gifts>
                        <li>квиток до залу на <a href="https://7eminar.com/23012020" target="_blank">Великий Річний Семінар (23.01.2020)</a> </li>
                    ...
                    <template v-slot:old-price>
                        <div class="package__old-price" style="text-decoration: line-through">3314 грн</div>
                    </template>
                </landing-package>
                <landing-package article="ep-interbuh_pp_1012">
                    <template v-slot:title>
                    ...
                    <template v-slot:old-price>
                        ...
                        <div class="package__old-price" style="text-decoration: line-through">4658 грн</div>
                    </template>
                </landing-package>

                    <landing-package article="ep-interbuh_7ib_1012" class="package-plus package-plus-top">
                        <template v-slot:title>
                            <span> ТАРИФ <br>   «Інтербух  + 7eminar.com»<br>та подарунки</span>
                        </template>
                        <template v-slot:period><div class="period">січень - червень 2020 року</div> </template>
                        <template v-slot:gifts>
                            <li>квиток до залу на <a href="https://7eminar.com/23012020" target="_blank">Великий Річний Семінар (23.01.2020)</a> </li>
                            <li><a href="https://www.club-cdma.com.ua/power-bank-remax-lipmax-rpl-12-2400-mah/" target="_blank">powerbank</a> для леді</li>
                        </template>
                        ...
                        <template v-slot:old-price>
                            ...
                            <div  class="package__old-price" style="text-decoration: line-through">4310 грн</div>
                        </template>
                    </landing-package>
            </landing-package-row>
        </template>
