<template>
    <landing name="msfz_november2019_4" advantages="epressa_add_msfz" class="landing-msfz_november2019_4">
                    ...
                    <div class="container container--august">
                        <div class="cover">
                            <picture class="cover__img">
                                <source :src="mix('images/head_041.webp')" type="image/webp">
                                <img :src="mix('images/head_041.jpg')" class="img-fluid" alt="">
                            </picture>
                        </div>
                    </div>
                </div>
        ...
        <template v-slot:packages_list>
            <landing-package-row>
                <landing-package :article="tab =='6' ?  'ep-msfz_2111' : 'ep- msfz_2711_g'">
                        ...
                        <li>відеокурс <br> <a href="https://7eminar.com/prybutok_msfz2019" target="_blank">«Податок на прибуток та МСФЗ»</a></li>
                    ...
                    <template v-slot:old-price>
                        <div  v-if="tab =='6'" class="package__old-price" style="text-decoration: line-through">5608 грн</div>
                        <div  v-else class="package__old-price" style="text-decoration: line-through">7308 грн</div>
                    </template>
                    </landing-package>
            </landing-package-row>
        </template>
