<template>
    <landing name="contr-agent_september2020_1" advantages="epressa_add_interbuh" class="landing-contr-agent_september2020_1">
                        ...
                        <div class="cover">
                            <a class="d-none d-md-block" href="#gift">
                                <picture class="cover__img">
                                    <source :src="mix('images/head_CONTR_AGENT.webp')" type="image/webp">
                                    <img :src="mix('images/head_CONTR_AGENT.jpg')" class="img-fluid" alt="IB">
                                </picture>
                            </a>
                          <a class="d-block d-md-none" href="#gift">
                            <picture class="cover__img">
                              <source :src="mix('images/mobilу_ca.webp')" type="image/webp">
                              <img :src="mix('images/mobilу_ca.jpg')" class="img-fluid" alt="IB">
                            </picture>
                          </a>
                        </div>
                    </div>
            ...
            <landing-package-row>
                <landing-package article="ep-contr-agent_ek_action">
                    ...
                    <template v-slot:gifts>
                        <li >Відеозапис семінару <br> <a href="https://7eminar.com/16092020" target="_blank"> «Перевірки<br> податкової/Держпраці»</a> </li>
                        <li>Сертифікат <br> Розетка або Алло <br> на 3000 грн</li>
                    </template>
              ...
              <landing-package article="ep-contr-agent_pp_action">
                <template v-slot:title>
