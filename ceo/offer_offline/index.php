          ...
          <div class="hero__images">
            ...
            <div class="hero__form">
              <form class="form zoho_url" id="form" method="post">
                ...
                <p class="form__title">
                  Тільки для учасників ефіру діє <span>знижка до 25%</span>
                </p>
        ...
        <div class="format__table">
          <div class="container">
            ...
            <table>
              ...
              <tr>
                <td>
                  Offline-сесії – пропрацювання бізнес-кейсів та зустрічі з
                  експертами з різних галузей
                </td>
              ...
              <tr>
                <td>
                  Offline-нетворкінг – знайомства з передовими підприємцями та
                  нові партнерства
                </td>
              ...
              <tr>
                <td>Захист результатів навчання</td>
              ...
              <tr>
                <td>Церемонія вручення сертифікатів та святковий нетворкінг</td>
    ...
    <script>
      $(document).ready(function () {
        ...
        let cDate = "5 вересня",
          ...
          // success_url
          cSuccess_url =
            "https://ceo.bizconstructor.com/offer_offline/thanks.html";
        ...
        if (cLandingIdOffline !== "id") {
          $(".offline_price").attr("data-id", cLandingIdOffline);
        }
      ...
      $("#btn-offline").click(function () {
        $(".packages-btns__pack-name.offline_price").click();
      });
    </script>
    <script>
      document.write(
