<template>
    <landing name="dtkt_october2020_3" advantages="epressa_add_interbuh" class="landing-dtkt_october2020_3">
                        ...
                        <div class="cover">
                            <a class="d-none d-md-block" href="#gift">
                                <picture class="cover__img">
                                    <source :src="mix('images/е-presa_dk.webp')" type="image/webp">
                                    <img :src="mix('images/е-presa_dk-min.jpg')" class="img-fluid" alt="dk">
                                </picture>
                            </a>
                          <a class="d-block d-md-none" href="#gift">
                            <picture class="cover__img">
                              <source :src="mix('images/320_dk.webp')" type="image/webp">
                              <img :src="mix('images/320_dk-min.jpg')" class="img-fluid" alt="dk">
                            </picture>
                          </a>
                        </div>
                    </div>
            ...
            <landing-package-row>
                ...
                <landing-package article="ep-dtkt_pp_gift1" class="package__three package__plus-top">
                    ...
                    <div v-if="show">
                      ...
                      <li>Велика настільна книга</li>
                      <li>Звітність у «СОТА»</li>
                      <li class="package__abilities-item-platform">Бухгалтерська відеоплатформа  <a href="https://7eminar.ua" target="_blank">7eminar.ua</a>: понад 190 курсів та вебінарів для перегляду
