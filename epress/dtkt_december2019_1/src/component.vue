<template>
    <landing name="dtkt_december2019_1" advantages="epressa_add_dtkt" class="landing-dtkt_december2019_1">
                    ...
                    <div class="container container--august">
                        <div class="cover">
                             <picture class="cover__img">
                                 <source :srcset="mix('images/head_05_webp.webp')" type="image/webp">
                                 <img :src="mix('images/head_05.jpg')" class="img-fluid" alt="coffe">
                             </picture>
                        </div>
                    </div>
                </div>
        ...
        <template v-slot:packages_list>
            <landing-package-row >
                <landing-package article="ep-dtkt_ek_1012">
                        <template v-slot:title>
                            <span >ЕКСПЕРТ<br>та подарунок</span>
                          </template>
                        <template v-slot:period><div class="period">січень – грудень 2020</div> </template>
                        <template v-slot:gifts>
                            <li>квиток до залу на Великий Річний Семінар (23.01.2020)</li>
                        </template>
                        ...
                        <template v-slot:old-price>
                            <div  class="package__old-price" style="text-decoration: line-through">2830 грн</div>
                        </template>
                    </landing-package>

                <landing-package article="ep-dtkt_ek_1012p">
                        <template v-slot:title>
                            <span>ЕКСПЕРТ + 7eminar.ua<br>та подарунок</span>
                        </template>
                    <template v-slot:period><div class="period">січень – грудень 2020</div> </template>
                    <template v-slot:gifts>
                        <li>квиток до залу на Великий Річний Семінар (23.01.2020)</li>
                        ...
                        <template v-slot:abilities>
                            ...
                            <li class="package__abilities-item-platform">Бухгалтерська відеоплатформа  <a href="https://7eminar.ua" target="_blank">7eminar.ua</a>: понад 120 курсів та вебінарів для перегляду
                                <br> (січень – грудень 2020 р.)</li>
                        </template>
                        <template v-slot:old-price>
                            <div class="package__old-price" style="text-decoration: line-through">4888 грн</div>
                        </template>
                    </landing-package>

                <landing-package article="ep-dtkt_pr_1012">
                    <template v-slot:title>
                    ...
                    <template v-slot:old-price>
                        <div class="package__old-price" style="text-decoration: line-through">4186 грн</div>
                    </template>
                </landing-package>

                <landing-package article="ep-dtkt_pp_1012" class="package-plus package-plus-top">
                    <template v-slot:title>
                    ...
                    <template v-slot:old-price>
                        <div   class="package__old-price" style="text-decoration: line-through">5986 грн</div>
                    </template>
                </landing-package>
            </landing-package-row>
