...
<html lang="uk-UA">
  <head>
    ...
    <title>
      Інтенсивна освітня програма для керівників медичного бізнесу Medical Ceo
    </title>
    <!-- SEO-->
    <meta
      property="og:title"
      content="Інтенсивна освітня програма для керівників медичного бізнесу Medical Ceo"
    />
    <meta
  ...
  <body>
        ...
        <div class="hero__container">
          ...
          <div class="hero__content">
            ...
            <h1 class="hero__title">
              Інтенсивна <span>освітня програма</span> <br />для керівників
              медичного бізнесу <b><i>Medical</i> Ceo</b>
            </h1>
      ...
      <section class="pain" id="pain">
        <div class="pain__container">
          <h2 class="results__title">
            <span>Вам точно треба ця програма</span>, якщо маєте хоча б одну з
            цих пробем у своєму бізнесі:
          </h2>
          <ul class="pain__info_list">
            <li>Управління медичним закладом відбувається хаотично</li>
            <li>У команди неякісно вибудовані бізнес-процеси</li>
            <li>Лікарі йдуть з вашого бізнесу, забирачи з собою і клієнтів</li>
            <li>Немає ефективної системи залучення нових пацієнтів</li>
            <li>Відсутній стабільний потік клієнтів</li>
            <li>Команда демотивована та виснажена</li>
            <li>Підбір співробітників довгий та неефективний</li>
            <li>
              Бізнес не розвивається і немає розуміння, як зрушити з місця
            </li>
          </ul>
        </div>
      </section>
      ...
      <section class="about" id="about">
        <div class="about__container">
          ...
          <p class="about__text2">
            Окремий великий сегмент наших клієнтів — медичний бізнес. Сьогодні
            ми раді представити новий вузькоспеціалізований освітній продукт
            саме для навчання перших осіб медичних компаній.
          </p>
          ...
          <div class="about__info">
            <p class="about__info_text">
              ...
              всі необхідні знання та компетенції, які дозволять вам стати
        ...
        <div class="packages__container">
          ...
          <div class="packages__items">
            <div class="item item--core core_price" data-id="">
              ...
              <ul class="item__info">
                <li>
                  3 місяці навчання в онлайн-форматі по 13 модулям програми
                </li>
            ...
            <div class="item item--pro pro_price" data-id="">
              ...
              <ul class="item__info">
                <li>
                  4 місяці навчання в онлайн-форматі по 17 модулям програми
                </li>
                <li>Доступ до бібліотеки практичних матеріалів та шаблонів</li>
                <li>Супровід персональним бізнес-консультантом</li>
                <li>Щотижневий розбір кейсів з Кирилом Куницьким</li>
                ...
                <li>
                  <b
                    >Додаткові 4 модулі програми для опанування важливих
                    управлінських компетенцій та підвищення особистої
                    ефективності СЕО</b
                  >
                </li>
              </ul>
    ...
    <script>
      $(document).ready(function () {
        ...
        let cDate = "18 січня ",
          // Landing id // Online
          cLandingId = "2108311000886639032 ",
          // Landing id // Online Pro
          cLandingIdPro = "2108311000886639059 ",
          // es_mail_id
          cMail_id = "",
          // es_id
          cEs_id = "1154",
