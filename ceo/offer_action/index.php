...
<head>
    ...
    <meta http-equiv="refresh" content="0;url=https://ceo.bizconstructor.com/offer_ceo/">
    <link rel="stylesheet" href="css/libs.min.css">
    <link rel="stylesheet" href="css/main.css">
    <link rel="icon" href="https://bizconstructor.com/ua/wp-content/uploads/sites/8/2019/08/cropped-Frame-32x32.png"
        sizes="32x32">
    <link rel="icon" href="https://bizconstructor.com/ua/wp-content/uploads/sites/8/2019/08/cropped-Frame-192x192.png"
        sizes="192x192">
    ...
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=422318891243887&ev=PageView&noscript=1" /></noscript>
    <!-- End Meta Pixel Code -->
        ...
        <section class="hero" id="hero">
            <div class="hero__container">
                <div class="hero__content">
                    ...
                    <h1 class="hero__title">Інтенсивна <span>освітня програма</span> для керівників бізнесу <b>Ceo</b></h1>
                        ...
                        <form class="form zoho_url" id="form" method="post">
                            ...
                            <label class="input__wrap">
                                <input class="input" name="phone" type="tel"
                                    placeholder="Твій номер телефону" required="">
                            </label>
                            <label class="input__wrap">
                            ...
                            <div class="hidden">
                                ...
                                <input type="hidden" name="token"
                                    value="LapQMWHF9k5QPPGRkfRnAtACAGwUcX2tkaVgyDuQe76crMGnrU" autocomplete="off">
                                <input type="hidden" name="success_url" value="" autocomplete="thanks.html">
                                <input type="hidden" name="error_url" value="" autocomplete="off">
                                <input type="hidden" name="redirect" value="false" autocomplete="off">
                                <input type="hidden" name="send_to_gf" value="ceo_offer_action">
                            </div>
                ...
                <div class="packages__items">
                    <div class="item item--core package_price core_price" data-id="">
                        ...
                        <ul class="item__info">
                            ...
                            <li>Супровід персональним бізнес-консультантом протягом <b>3х місяців</b></li>
                            <li>Щотижневий розбір кейсів з Кирилом Куницьким <b>(12 онлайн-зустрічей)</b></li>
                            <li>Спілкування з іншими участниками в закритій групі в Telegram</li>
                            <li>Додатковий доступ до програми <b>3 місяцi</b> після її завершення</li>
                        ...
                        <a class="item__btn" id="btn-core" href="#register" data-package="core">ВИБРАТИ</a>
                    </div>
                    <div class="item item--pro package_price pro_price" data-id="">
                        ...
                        <ul class="item__info">
                            ...
                            <li>Спілкування з іншими участниками в закритій групі в Telegram</li>
                            <li>Додатковий доступ до програми <b>3 місяцi</b> після її завершення</li>
                            <li>Участь в майстер-майндах по колективному знаходженню рішень поточних задач <b>(4
                                    онлайн-зустрічі)</b>
                            </li>
                        </ul>
                        <div class="item__price">
                        ...
                        <a class="item__btn" id="btn-pro" href="#register" data-package="pro">ВИБРАТИ</a>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="block">
                    ...
                    <div class="block__form">
                        <form class="form zoho_url" id="form" method="post">
                            ...
                            <p class="form__title">Реєстрація</p>
                            <label class="input__wrap">
                                <input class="input name" name="name" type="text" placeholder="Твоє ім’я" required="">
                            </label>
                            <label class="input__wrap">
                                <input class="input phone" name="phone" type="tel"
                                    placeholder="Твій номер телефону" required="">
                            </label>
                            <label class="input__wrap">
                                <input class="input email" name="email" type="email" placeholder="Твій email" required="">
                            </label>
                            <div class="hidden">
                                <input type="hidden" name="ref" value="" autocomplete="off">
                                <input type="hidden" name="ga" value="" autocomplete="off">
            ...
            <div class="footer__container">
                <div class="footer__menu">
                    ...
                    <ul class="footer__menu_list">
                        <li>
                            <a
                                href="http://bizconstructor.com/about?_ga=2.150560566.1675371198.1664796566-206334048.1655729050">Про
                                Нас</a>
                        </li>
                        <li>
                            <a
                                href="http://bizconstructor.com/blog?_ga=2.150631350.1675371198.1664796566-206334048.1655729050">Блог
                                Бізнес-Конструктор</a>
                        </li>
                        <li>
                            <a
                                href="http://www.kunitsky.com/?_ga=2.150631350.1675371198.1664796566-206334048.1655729050">Блог
                                Кирила Куницького</a>
                        </li>
                        <li>
                            <a
                                href="https://www.work.ua/jobs/by-company/448901?_ga=2.153252920.1675371198.1664796566-206334048.1655729050">Робота
                                в Бізнес-Конструктор</a>
                        </li>
                    </ul>
                </div>
                <div class="footer__links">
                    ...
                    <ul class="footer__menu_list">
                        ...
                        <li>
                            <a
                                href="http://terms-conditions.bizconstructor.com/ua?_ga=2.75242514.1675371198.1664796566-206334048.1655729050">Публічна
                                оферта UA</a>
                        </li>
                    </ul>
                </div>
...
/*             let months = ['січня', 'лютого', 'березня', 'квітня', 'травня', 'червня', 'липня', 'серпня', 'вересня', 'жовтня', 'листопада', 'грудня']
            ...
            // let cDate = tomorrowDate.getDate() + ' ' + months[tomorrowDate.getMonth()],
                ...
                // Landing id // Online
                cLandingId = '2108311000754827094',

                // Landing id // Online Pro
                cLandingIdPro = '2108311000754827061',
                ...
                cSuccess_url = 'https://ceo.bizconstructor.com/offer_action/thanks.html';
