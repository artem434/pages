<template>
    <landing name="msfz_december2020" advantages="epressa_add_interbuh" class="landing-msfz_march2021_1">
              ...
              <div class="cover">
                <a class="d-none d-md-block" href="#gift">
                  <picture class="cover__img">
                    <source :src="mix('images/03msfz.webp')" type="image/webp">
                    <img :src="mix('images/03msfz-min.jpg')" class="img-fluid" alt="IB">
                  </picture>
                </a>
                <a class="d-block d-md-none" href="#gift">
                  <picture class="cover__img">
                    <source :src="mix('images/03_msfzmob.webp')" type="image/webp">
                    <img :src="mix('images/03_msfzmob-min.jpg')" class="img-fluid" alt="IB">
                  </picture>
                </a>
              </div>
            </div>
