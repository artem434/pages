<template>
    <landing name="dtkt_december2020" advantages="epressa_add_interbuh" class="landing-dtkt_february2021">
                    ...
                    <div class="container">
                        <div class="cover">
                          ...
                          <a class="d-block d-md-none" href="#gift">
                            <picture class="cover__img">
                              <source :src="mix('images/dk_mob.webp')" type="image/webp">
                              <img :src="mix('images/dk_mob-min.jpg')" class="img-fluid" alt="dk">
                            </picture>
                          </a>
                        </div>
                    </div>
        ...
        <template v-slot:packages_list>
          <h2  id="gift" class="packages__title">{{ page.options['order_title-top']}}</h2>
            <landing-package-row>
                <landing-package article="ep-dtkt_ek_gift2">
...
<!--                      <div class="package__month">3 місяці</div>-->
                      <p class="package__custom-price">
                        <price article="ep-dtkt_ek_gift2" :options="{periods: 1}" format="0"/>
                       <b>грн/міс.</b>
                      </p>
                    </template>
                ...
                <landing-package article="ep-ep-dtkt_pp_gift2" class="package__three package__plus-top">
                        <template v-slot:title>
                          <span>ПРОФІ + 7eminar.ua<br>та подарунки</span>
                            ...
                            <template v-slot:period>
                              ...
                              <p class="package__custom-price">
                                <price article="ep-ep-dtkt_pp_gift2" :options="{periods: 1}" format="0"/>
                                <b>грн/міс.</b>
                              </p>
                            </template>
                  <template v-slot:gifts>
          ...
          <landing-package-row class="package-two">
            ...
            <landing-package article="ep-dtkt_pr_action2" class="package__two">
              <template v-slot:title>
            ...
            <landing-package article="ep-dtkt_pp_action2" class="package__three">
              <template v-slot:title>
