...
<html lang="uk-UA">
  <head>
    ...
    <title>
      СЕО готельного бізнесу | Індивідуальна освітня програма для керівників |
      Бізнес-Конструктор
    </title>
    <!-- SEO-->
    <meta
      property="og:title"
      content="СЕО готельного бізнесу | Індивідуальна освітня програма для керівників | Бізнес-Конструктор"
    />
    <meta
  ...
  <body>
          ...
          <div class="hero__container">
            ...
            <div class="hero__content">
              <p class="hero__title">
                ...
                програма для
                <span>керівників</span>

                <!-- <strong>12 березня</strong> -->
              </p>
              <h1>CEO</h1>
              <h2>готельного бізнесу</h2>
        ...
        <div class="for__container">
          <div class="for__block">
            ...
            <div class="for__items">
              <div class="item">
                <h3 class="item__title">CEO готельного бізнесу</h3>
                <p class="item__text">
                  які хочуть вивести готельну мережу на новий рівень, підвищити
                  заповнюваність та оптимізувати бізнес-процеси.
                </p>
              </div>
              <div class="item">
                <h3 class="item__title">Керуючі готельними комплексами</h3>
                <p class="item__text">
                  які хочуть впровадити сучасні методи управління,
                  автоматизувати операції та підвищити рівень сервісу
                </p>
              </div>
              <div class="item">
                <h3 class="item__title">Власники готелів та апарт-готелів</h3>
                <p class="item__text">
                  що прагнуть збільшити прибутковість, розширити спектр послуг і
                  залучити нові категорії гостей
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="block">
            <div class="block__content">
              ...
              <p class="block__subtitle">
                НА ПРОГРАМУ «СЕО ГОТЕЛЬНОГО БІЗНЕСУ» <br />
    ...
    <script>
      $(document).ready(function () {
        ...
        let cDate = "5 вересня",
          // Landing id // Online
          cLandingId = "2108311001034726001",
          // Landing id // Online Pro
          cLandingIdPro = "2108311001034726001",
          // Landing id // Online Pro
          cLandingIdPremium = "2108311001034726026",
          // es_mail_id
          cMail_id = "",
          // es_id
          cEs_id = "1154",
          // success_url
          cSuccess_url =
            "https://ceo.bizconstructor.com/hotelceo/offer/thanks.html";
