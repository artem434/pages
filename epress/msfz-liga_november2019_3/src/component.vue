<template>
    <landing name="msfz-liga_november2019_3" advantages="epressa_add_msfz-liga" class="landing-msfz-liga_november2019_3">
                    ...
                    <div class="container container--august">
                        <div class="cover">
                            <picture class="cover__img">
                                <source :src="mix('images/head_03_vmsfz_webp1.webp')" type="image/webp">
                                <img :src="mix('images/head_03_vmsfz1.jpg')" class="img-fluid" alt="coffe">
                            </picture>
                        </div>
                    </div>
                </div>
        ...
        <template v-slot:packages_list>
            <landing-package-row >
                <landing-package :article="tab =='6' ?  'ep-msfz-liga_2111' : 'ep-msfz-liga_2711_g'">
                    ...
                    <template v-slot:old-price>
                        <div  v-if="tab =='6'" class="package__old-price" style="text-decoration: line-through">3258 грн</div>
                        <div  v-else class="package__old-price" style="text-decoration: line-through">4958 грн</div>
                    </template>
                </landing-package>
            </landing-package-row>
        </template>
