...
<html lang="ru-RU">
  <head>
    ...
    <title>
      Medical CEO | Інтенсивна освітня програма для керівників |
      Бізнес-Конструктор
    </title>
    <!-- SEO-->
    <meta
      name="description"
      content="Стань еталонним лідером для команди в своєму медичному бізнесі"
    />
    <meta
      property="og:title"
      content="Medical CEO | Інтенсивна освітня програма для керівників | Бізнес-Конструктор"
    />
    <meta
  ...
  <body>
        ...
        <div class="hero__container">
          ...
          <div class="hero__content">
            <h1 class="hero__title">
              Інтенсивна <span>освітня програма</span> для керівників медичного
              бізнесу <b><i>Medical</i> Ceo</b>
            </h1>
    ...
    <script>
      $(document).ready(function () {
        ...
        let cDate = "18 січня ",
          // Landing id // Online
          cLandingId = "2108311000817881047",
          // Landing id // Online Pro
          cLandingIdPro = "2108311000817881070",
          // es_mail_id
          cMail_id = "",
          // es_id
          cEs_id = "1154",
          // success_url
          cSuccess_url =
            "https://medceo.bizconstructor.com/offer/thanks/thanks.html";
