...
<head>
  ...
  <title>Інтенсивна освітня програма для керівників бізнесу</title>
  <!-- SEO-->
  <meta property="og:title" content="Інтенсивна освітня програма для керівників бізнесу CEO">
...
<!--              <p class="cDate">5 вересня</p>-->
          ...
          <h1 class="hero__title">Інтенсивна <span>освітня програма</span> для керівників бізнесу <b>Ceo</b>
          </h1>
    ...
    <section class="about" id="about">
      <div class="about__container">
        ...
        <p class="about__text2">Сьогодні ми раді представити тобі кульмінацію багаторічних напрацювань — найбільш ефективну та концентровану освітню програму для навчання перших осіб компаній.</p>
        <div class="about__block">
          <h2 class="about__title">Назва освітньої програми
            <br> говорить сама за себе — <i>« <b>Ceo</b> »</i>
          </h2>
        </div>
        <div class="about__info">
          <p class="about__info_text">Цей 3-місячний курс дозволить тобі в найкоротші терміни здобути всі необхідні знання та компетенції, які дозволять тобі стати еталонним CEO для своєї компанії.</p>
    ...
    <section class="results" id="results">
      <div class="results__container">
        ...
        <div class="results__block">
          <p class="results__block_title">Програма <span>« <b>Ceo</b> »</span>
          </p>
        ...
        <div class="packages__items">
          <div class="item item--core core_price" data-id="">
            ...
            <ul class="item__info">
              ...
              <li>Супровід персональним бізнес-консультантом протягом 3х місяців</li>
              ...
              <li>Участь в майстер-майндах по колективному знаходженню рішень поточних задач <b>(3 онлайн-зустрічі)</b></li>
            </ul>
          ...
          <div class="item item--pro pro_price" data-id="">
            ...
            <ul class="item__info">
              ...
              <li>Доступ до бібліотеки практичних матеріалів та шаблонів</li>
              <li>Супровід персональним бізнес-консультантом протягом <b>4х місяців</b>
              </li>
              <li>Щотижневий розбір кейсів з Кирилом Куницьким <b>(16 онлайн-зустрічей)</b>
              </li>
              <li>Участь в майстер-майндах по колективному знаходженню рішень поточних задач <b>(4 онлайн-зустрічі)</b>
              </li>
              <li>Спілкування з іншими участниками в закритій групі в Telegram</li>
              <li>Додатковий доступ до програми 3 місяцi після її завершення</li>
            </ul>
      ...
      <div class="register__container">
        ...
        <div class="block">
          <div class="block__content">
            ...
            <p class="block__subtitle">НА ПРОГРАМУ «СЕО»
...
<!--                <p class="cDate">5 вересня</p>-->
            ...
            <div class="block__logo lazy" data-bg="img/block__logo.svg"></div>
          </div>
