        ...
        execute: function () {
            ...
            jquery_1.default(function ($) {
                $('.slider').slick({
                    ...
                    slidesToScroll: 1,
                    dots: false,
                    prevArrow: '<div id="pause_video" class="prev"><i class="fa fa-arrow-left" aria-hidden="true"></i></div>',
                    nextArrow: '<div id="pause_video" class="next"><i class="fa fa-arrow-right" aria-hidden="true"></i></div>',
                    fade: true
                });
